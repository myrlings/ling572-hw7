...
def create_dirs(output_dirname, class_map):
    ...
    for number in class_map:
        number = str(number)
        dirname = output_dirname + "/" + number + "-vs-all"
...
def store_vectors(vectors, dirname, m, class_map, filename):
    # open file
    temp_path = dirname + "/" + m + "-vs-all/" + filename
...
# create directory for each m-vs-all
create_dirs(output_dirname, class_map)
# output train and test for the each m-vs-all
for index in class_map:
    store_vectors(train_vectors, output_dirname, index, class_map, "train")
    store_vectors(test_vectors, output_dirname, index, class_map, "test")
